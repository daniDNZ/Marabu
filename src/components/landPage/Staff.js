import staff2 from "../../img/staff/staff2.jpg";
import staff1 from "../../img/staff/staff1.jpg";
import staff3 from "../../img/staff/staff3.jpg";
        ...
        <>
            ...
            <div className="d-md-flex flex-md-equal w-100 mt-2 mb-5 ps-md-3 text-dark fw-light">
                <div className="me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <img className="rounded-circle " alt="Foto de perfil" src={staff2} style={{ width: "140px", height: "140px" }}></img>
                ...
                <div className="me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <img className="rounded-circle" alt="Foto de perfil" src={staff3} style={{ width: "140px", height: "140px" }}></img>
                ...
                <div className="me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    <img className="rounded-circle" alt="Foto de perfil" src={staff1} style={{ width: "140px", height: "140px" }}></img>
